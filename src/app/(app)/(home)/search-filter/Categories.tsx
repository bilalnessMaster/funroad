...
const Categories = ({ data }: Props) => {
    ...
    return (
        ...
        >
            ...
            <div ref={viewRef}>
                 <Button variant={'elevated'} className={cn('h-11 px-4 border-transparent rounded-full hover:bg-white hover:border-primary text-black', { 'bg-white hover:border-primary': !isActiveCategoryHidden && !isAnyHovered , })}
