  ...
  return (
    <div className="border rounded-md bg-white">
      <div className="p-4 border-b flex items-center justify-between">
        ...
        { hasAnyFilters && <button className="underline cursor-pointer" onClick={onClear} type="button">clear</button>}
      </div>
      <ProductFilter title="Price" className="uwu" >
        <PriceFilter
       ...
       <ProductFilter title="Tags" className="uwu" >
